...
,MIN(if(e.vaccinecode in ('DTP5','D15','D25','D35','D45','D55'),e.dateepi,NULL)) as 'DTP5'
,MIN(if(e.vaccinecode in ('OPV5','D45','D55'),e.dateepi,NULL)) as 'OPV5'
...
AND p.nation='99'
AND p.birth BETWEEN DATE_SUB(@d1, INTERVAL 5 YEAR) AND DATE_SUB(@d2, INTERVAL 5 YEAR)
