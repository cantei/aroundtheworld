BEGIN
      ...
      ENGINE=InnoDB DEFAULT CHARSET=utf8;
		...
		INSERT INTO table11 (pcucodeperson,pid,birth,age_day,age_week,age_month) 
...
BLOCK1: begin
	...
	DECLARE n INT  ;
	DECLARE l INT  ;
	DEClARE 	personcursor CURSOR FOR SELECT pid,age_day,age_week,age_month FROM  table11 ;
